        ...
        <form action="{{ route('clientes.store') }}" method="post">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="tipo_persona" id="tipo_persona" class="form-control">
                ...
                <div class="col-md-12 mb-2" id="box-razon-social">
                    ...
                    <label id="label-juridica" for="razon_social" class="form-label">Nombre Empresa</label>
